...
class SongsRepositoryImpl implements SongsRepository {
  ...
  @override
  Future<List<SongsModel>> getPlaylistSongs() async {
    return await _appLocalStorage.getPlayListData();
  }
  
  @override
  Future<List<SongsModel>> deletePlaylistSongs() async {
   return await _appLocalStorage.deletePlaylistSongs();
  }
}
